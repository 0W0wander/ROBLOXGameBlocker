...
function addBlockButtons() {
    ...
    gameLinksWithId.forEach(link => {
        if (link.querySelector('.game-block-btn')) return;
        ...
        const thumbnailContainer = link.querySelector('.thumbnail-2d-container') || 
                                   link.querySelector('.game-card-thumb-container') ||
                                   link.querySelector('[class*="thumbnail"]') ||
                                   link.querySelector('span > img')?.parentElement ||
                                   link.querySelector('img')?.parentElement;
    ...
    listItemCards.forEach(card => {
        ...
        const thumbnailContainer = card.querySelector('.thumbnail-2d-container') ||
                                   card.querySelector('.game-card-thumb-container') ||
